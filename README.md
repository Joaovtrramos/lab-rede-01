![GitHub License](https://img.shields.io/github/license/Joaovtrramos/lab-rede-01)
...
|-------------|-------------|---------------|---------------|
| Roteador | Estatistica| 192.168.0.1|IP do roteador |
|Impressora| Reserva DHCP| 192.168.01
